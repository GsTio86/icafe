...
/**
 * Linked list implementation of the list using a header node. Access to the list is via
 * LinkedListItr.
 *
...
public class LinkedList<E> {
  ...
  /**
   * Return an iterator representing the first node in the list. This operation is valid for empty
   * lists.
   */
   ...
   *
   * @param x the item to search for.
   * @return appropriate iterator if the item is found. Otherwise, the iterator corresponding to the
   * last element in the list is returned.
   */
