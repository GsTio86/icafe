...
public class NumberUtils {
  ...
  public static String changeToDecimalFormat(Object number) {
    ...
    bdNumber =
        bdNumber.stripTrailingZeros();           //Returns a BigDecimal with any trailing zero's removed
    String pattern =
        "###,##0.0###########";    //To apply formatting when the number of digits in input equals the pattern
