 ...
 * <p/>
 * Given that image-scaling operations, especially when working with large images, can be very
 ...
 * <p/>
 * Up until now it was left to the caller to implement their own serialization or limiting logic to
 * handle these use-cases. Given imgscalr's popularity in web applications it was determined that
 ...
 * <p/>
 * Every method in this class wraps the matching methods in the {@link Scalr} class in new {@link
 ...
 * two main.resources you want to watch closely:
 * <ol>
 ...
 * offered by this class, you don't need to worry about wasted main.resources or
...
public class AsyncScalr {
   ...
   * <p/>
   * You can call {@link ExecutorService#shutdown()} to wait for all scaling operations to complete
   * first or call {@link ExecutorService#shutdownNow()} to kill any in-process operations and purge
   * all pending operations before exiting.
   * <p/>
   * Additionally you can use {@link ExecutorService#awaitTermination(long, TimeUnit)} after issuing
   * a shutdown command to try and wait until the service has finished all tasks.
   *
   ...
   * <p/>
   * If <code>service</code> is <code>null</code>, has been shutdown or terminated then this method
   * will replace it with a new {@link ExecutorService} by calling the {@link #createService()}
   * method and assigning the returned value to <code>service</code>.
   * <p/>
   * Any subclass that wants to customize the {@link ExecutorService} or {@link ThreadFactory} used
   * internally by this class should override the {@link #createService()}.
   */
  ...
  protected static class DefaultThreadFactory implements ThreadFactory {
     ...
     * <p/>
     * Thread created by this factory are utilized by the parent {@link ExecutorService} when
