 ...
 * WY    22Jan2015  Revised read(InputStream) to leave the stream open WY    08Jan2015  Added
 * getReader(PushbackInputStream) WY    22Sep2014  Added read() to detect image type and read image
...
public final class ImageIO {
  ...
  public static void write(BufferedImage img, OutputStream os, ImageType imageType)
      throws Exception {
    write(img, os, imageType, ImageParam.DEFAULT_IMAGE_PARAM);
  }

  public static void write(BufferedImage img, OutputStream os, ImageType imageType,
      ImageParam imageParam) throws Exception {
