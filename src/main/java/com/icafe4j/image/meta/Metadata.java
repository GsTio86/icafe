 ...
 * WY    07Apr2018  Added extractThumbnail(InputStream) to extract a single thumbnail WY
 * 06Apr2018  Added extractThumbnails(InputStream) to extract an array of thumbnails WY    02Mar2017
 *  Added insertMetadata(Collection<Metadata>, InputStream, OutputStream) WY    26Sep2015  Added
 * insertComment(InputStream, OutputStream, String) WY    06Jul2015  Added insertXMP(InputSream,
 * OutputStream, XMP) WY    16Apr2015  Changed insertIRB() parameter List to Collection WY
 * 03Mar2015  Added insertXMP() WY    03Feb2015  Added insertExif() WY    03Feb2015  Added
 * removeExif() WY    03Feb2015  Added insertICCProfile() WY    27Jan2015  Added insertIRB() WY
 * 26Jan2015  Added insertIPTC() WY    25Jan2015  Added extractThumbnails()
 */
 ...
 */
public abstract class Metadata implements com.icafe4j.image.meta.MetadataReader,
    Iterable<com.icafe4j.image.meta.MetadataEntry> {
    ...
    switch (imageType) {
      ...
      default:
        ...
        throw new IllegalArgumentException(
            "Thumbnail extracting is not supported for " + imageType + " image");
    }
  ...
  public static void insertComments(InputStream is, OutputStream os, List<String> comments)
    ...
    switch (imageType) {
      ...
      default:
        peekHeadInputStream.close();
        throw new IllegalArgumentException(
            "comment data inserting is not supported for " + imageType + " image");
    }
    peekHeadInputStream.shallowClose();
  }
  ...
  public static void insertExif(InputStream is, OutputStream os, Exif exif, boolean update)
    ...
    switch (imageType) {
      ...
      default:
        peekHeadInputStream.close();
        throw new IllegalArgumentException(
            "EXIF data inserting is not supported for " + imageType + " image");
    }
    peekHeadInputStream.shallowClose();
  }

  public static void insertICCProfile(InputStream is, OutputStream out, ICC_Profile icc_profile)
      throws IOException {
    insertICCProfile(is, out, icc_profile.getData());
  }

  public static void insertICCProfile(InputStream is, OutputStream out, byte[] icc_profile)
      throws IOException {
    // ImageIO.IMAGE_MAGIC_NUMBER_LEN bytes as image magic number
    PeekHeadInputStream peekHeadInputStream =
        new PeekHeadInputStream(is, ImageIO.IMAGE_MAGIC_NUMBER_LEN);
  ...
  public static void insertIPTC(InputStream is, OutputStream out, Collection<IPTCDataSet> iptcs)
      throws IOException {
  ...
  public static void insertIPTC(InputStream is, OutputStream out, Collection<IPTCDataSet> iptcs,
    ...
    switch (imageType) {
      ...
      default:
        peekHeadInputStream.close();
        throw new IllegalArgumentException(
            "IPTC data inserting is not supported for " + imageType + " image");
    }
    peekHeadInputStream.shallowClose();
  }

  public static void insertIRB(InputStream is, OutputStream out, Collection<_8BIM> bims)
      throws IOException {
  ...
  public static void insertIRB(InputStream is, OutputStream out, Collection<_8BIM> bims,
    ...
    switch (imageType) {
      ...
      default:
        peekHeadInputStream.close();
        throw new IllegalArgumentException(
            "IRB data inserting is not supported for " + imageType + " image");
    }
    peekHeadInputStream.shallowClose();
  }
  ...
  public static void insertIRBThumbnail(InputStream is, OutputStream out, BufferedImage thumbnail)
    ...
    switch (imageType) {
      ...
      default:
        peekHeadInputStream.close();
        throw new IllegalArgumentException(
            "IRB thumbnail inserting is not supported for " + imageType + " image");
    }
    peekHeadInputStream.shallowClose();
  }
  ...
  public static void insertXMP(InputStream is, OutputStream out, XMP xmp) throws IOException {
    ...
    switch (imageType) {
      ...
      default:
        peekHeadInputStream.close();
        throw new IllegalArgumentException(
            "XMP inserting is not supported for " + imageType + " image");
    }
    peekHeadInputStream.shallowClose();
  }
  ...
  public static Map<MetadataType, Metadata> readMetadata(InputStream is) throws IOException {
    ...
    switch (imageType) {
      ...
      default:
        peekHeadInputStream.close();
        throw new IllegalArgumentException(
            "Metadata reading is not supported for " + imageType + " image");
    ...
    switch (imageType) {
      ...
      default:
        ...
        throw new UnsupportedOperationException(
            "Metadata removing is not supported for " + imageType + " image");
    }
