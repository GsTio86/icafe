...
public enum GPSTag implements Tag {
  ...
  GPS_LONGITUDE("GPS Longitude", (short) 0x0004) {
    public String getFieldAsString(Object value) {
      ...
      if (intValues.length != 6) {
        throw new IllegalArgumentException(
            "Wrong number of GPSLongitude data number: " + intValues.length);
      }
      //formatting numbers up to 3 decimal places in Java
      DecimalFormat df = new DecimalFormat("#,###,###.###");
      return StringUtils.rationalToString(df, true, intValues[0], intValues[1]) + '\u00B0'
  ...
  GPS_ALTITUDE("GPS Altitude", (short) 0x0006) {
    public String getFieldAsString(Object value) {
      ...
      if (intValues.length != 2) {
        throw new IllegalArgumentException(
            "Wrong number of GPSAltitute data number: " + intValues.length);
      }
      //formatting numbers up to 3 decimal places in Java
      DecimalFormat df = new DecimalFormat("#,###,###.###");
  ...
  GPS_TIME_STAMP("GPS Time Stamp", (short) 0x0007) {
    public String getFieldAsString(Object value) {
      ...
      if (intValues.length != 6) {
        throw new IllegalArgumentException(
            "Wrong number of GPSTimeStamp data number: " + intValues.length);
      }
  ...
  GPS_IMG_DIRECTION("GPS Img Direction", (short) 0x0011) {
    public String getFieldAsString(Object value) {
      ...
      if (intValues.length != 2) {
        throw new IllegalArgumentException(
            "Wrong number of GPSImgDirection data number: " + intValues.length);
      }
      //formatting numbers up to 3 decimal places in Java
      DecimalFormat df = new DecimalFormat("#,###,###.###");
  ...
  GPS_DEST_LONGITUDE("GPS Dest Longitude", (short) 0x0016) {
    public String getFieldAsString(Object value) {
      ...
      if (intValues.length != 6) {
        throw new IllegalArgumentException(
            "Wrong number of GPSDestLongitude data number: " + intValues.length);
      }
      //formatting numbers up to 3 decimal places in Java
      DecimalFormat df = new DecimalFormat("#,###,###.###");
      return StringUtils.rationalToString(df, true, intValues[0], intValues[1]) + '\u00B0'
  ...
  GPS_DEST_BEARING("GPS Dest Bearing", (short) 0x0018) {
    public String getFieldAsString(Object value) {
      ...
      if (intValues.length != 2) {
        throw new IllegalArgumentException(
            "Wrong number of GPSDestBearing data number: " + intValues.length);
      }
      //formatting numbers up to 3 decimal places in Java
      DecimalFormat df = new DecimalFormat("#,###,###.###");
      return StringUtils.rationalToString(df, true, intValues) + "m";
  ...
  GPS_DEST_DISTANCE("GPS Dest Distance", (short) 0x001a) {
    public String getFieldAsString(Object value) {
      ...
      if (intValues.length != 2) {
        throw new IllegalArgumentException(
            "Wrong number of GPSDestDistance data number: " + intValues.length);
      }
      //formatting numbers up to 3 decimal places in Java
      DecimalFormat df = new DecimalFormat("#,###,###.###");
      return StringUtils.rationalToString(df, true, intValues) + "m";
  ...
  GPSTag(String name, short value) {
    this.name = name;
    this.value = value;
  }
