 ...
 * WY    01Oct2014  Moved from icafe4j.image.meta to icafe4j.image.meta.adobe
 */
...
public enum ImageResourceID {
  ...
  INDEXED_COLOR_TABLE("Obsolete. Photoshop 2.0 only. Contains the indexed color table.",
      (short) 0x03eb),
  ...
  EFFECTIVE_BW_VALUES("Two bytes for the effective black and white values for the dot range.",
      (short) 0x03fb),
  ...
  DOC_SPECIFIC_ID(
      ...
      (short) 0x0414),
  UNICODE_ALPHA_NAMES("Unicode Alpha Names. 4 bytes for length and the string as a unicode string.",
      (short) 0x0415),
  INDEXED_COLOR_TABLE_COUNT(
      "Indexed Color Table Count. 2 bytes for the number of colors in table that are actually defined",
      (short) 0x0416),
  TRANSPARENT_INDEX("Tansparent Index. 2 bytes for the index of transparent color, if any.",
      (short) 0x0417),
  GLOBLE_ALTITUDE("Global Altitude. 4 byte entry for altitude.", (short) 0x0419),
  SLICES("Slices.", (short) 0x041a),
  WORKFLOW_URL("Workflow URL. Unicode string, 4 bytes of length followed by unicode string.",
      (short) 0x041b),
  JUMP_TO_XPEP("Jump To XPEP. 2 bytes major version, 2 bytes minor version, 4 bytes count.",
      (short) 0x041c),
  ALPHA_IDENTIFIERS(
  ...
  COLOR_SAMPLERS_RESOURCE_CS3(
      "(Photoshop CS3) Color samplers resource. Also see ID 1038 for old format.", (short) 0x0431),
  MEASUREMENT_SCALE(
      "(Photoshop CS3) Measurement Scale. 4 bytes (descriptor version = 16), Descriptor.",
      (short) 0x0432),
  TIMELINE_INFO("(Photoshop CS3) Timeline Information. 4 bytes (descriptor version = 16).",
      (short) 0x0433),
  SHEET_DISCLOSURE("(Photoshop CS3) Sheet Disclosure. 4 bytes (descriptor version = 16).",
      (short) 0x0434),
  ...
  COUNT_INFO("(Photoshop CS4) Count Information. 4 bytes (descriptor version = 16).",
      (short) 0x0438),
  PRINT_INFO_CS5("(Photoshop CS5) Print Information. 4 bytes (descriptor version = 16).",
      (short) 0x043a),
  ...
  IMAGEREADY_VARIABLES("Image Ready variables. XML representation of variables definition.",
      (short) 0x1b58),
  ...
  ImageResourceID(String description, short value) {
