 ...
 * WY    10Apr2018  Add getAsString(ImageResourceId) WY    10Apr2018  Add iterator() implementation
 * WY    16Feb2017  Fix bug with zero size 8BIM block WY    14Apr2015  Added getThumbnailResource()
 * WY    10Apr2015  Added containsThumbnail() and getThumbnail() WY    19Jan2015  Initial creation
 */
...
public class IRB extends Metadata {
  ...
  public Iterator<MetadataEntry> iterator() {
    ...
    if (containsThumbnail) {
      ...
      items.add(
          new MetadataEntry("Thumbnail Padded row bytes", "" + thumbnail.getPaddedRowBytes()));
      ...
      items.add(new MetadataEntry("Thumbnail Size after compression",
          "" + thumbnail.getCompressedSize()));
      // Bits per pixel. = 24
