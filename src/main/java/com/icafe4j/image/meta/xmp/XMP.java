 ...
 * WY    03Apr2016  Added new constructor XMP(String, String) WY    31Mar2016  Moved to new package
 * WY    31Mar2016  Made XMP abstract and overrode write() method WY    03Jul2015  Added override
 * method getData() WY    05Mar2015  Revised getMergedDocument() WY    27Feb2015  Added support for
 * ExtendedXMP data WY    19Feb2015  Removed showMetadata() and added getXmpMeta() WY    19Feb2015
 * Renamed getXMLDocument() to getXmpDocument() WY    11Feb2015  Added getXMLDocument() and
 * showMetadata() WY    19Jan2015  Initial creation
 */
      ...
      switch (node.getNodeType()) {
        ...
        case Node.ELEMENT_NODE: { // Element node
          ...
          MetadataEntry element =
              new MetadataEntry(ele.getTagName(), attributes.toString().trim(), true);
