...
public enum TiffTag implements Tag {
    ...
    public String getFieldAsString(Object value) {
      ...
      if (intValues.length != 2) {
        throw new IllegalArgumentException(
            "Wrong number of XResolution data number: " + intValues.length);
      }
  ...
  Y_RESOLUTION("YResolution", (short) 0x011B, Attribute.BASELINE) {
    public String getFieldAsString(Object value) {
      ...
      if (intValues.length != 2) {
        throw new IllegalArgumentException(
            "Wrong number of YResolution data number: " + intValues.length);
      }
      //formatting numbers up to 3 decimal places in Java
      DecimalFormat df = new DecimalFormat("#,###,###.##");
      return StringUtils.rationalToString(df, true, intValues);
  ...
  T4_OPTIONS("T4 Options", (short) 0x0124, Attribute.EXTENDED) {
    public String getFieldAsString(Object value) {
      ...
      switch (intValue) {
        ...
        case 4:
          description =
              "Fill bits have been added as necessary before EOL codes such that EOL always ends on a byte boundary";
          break;
      }
  ...
  JPEG_TABLES("JPEGTables - optional, for new-style JPEG compression", (short) 0x015B,
      Attribute.EXTENDED) {
    public FieldType getFieldType() {
  ...
  JPEG_INTERCHANGE_FORMAT("JPEG Interchange Format/Jpeg IF Offset", (short) 0x0201,
      Attribute.EXTENDED) {
    public FieldType getFieldType() {
      return FieldType.LONG;
    }
  ...
  JPEG_INTERCHANGE_FORMAT_LENGTH("JPEG Interchange Format Length/Jpeg IF Byte Count",
      (short) 0x0202, Attribute.EXTENDED) {
    public FieldType getFieldType() {
      return FieldType.LONG;
    }
  },
  ...
  IT8_BITS_PER_EXTENDED_RUN_LENGTH("IT8 Bits Per Extended Run Length", (short) 0x84e5,
      Attribute.PRIVATE),
  ...
  // Photoshop image main.resources
  ...
  WINDOWS_XP_TITLE("WindowsXP Title", (short) 0x9c9b, Attribute.PRIVATE) {
    public String getFieldAsString(Object value) {
      ...
      String description = "";
      description = new String(byteValue, StandardCharsets.UTF_16LE).trim();
