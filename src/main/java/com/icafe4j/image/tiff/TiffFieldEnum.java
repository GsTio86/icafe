...
public class TiffFieldEnum {
  ...
  public enum PhotoMetric {
    ...
    RGB("RGB, value of (0,0,0) represents black, and (255,255,255) represents white, assuming 8-bit components",
        2),
  ...
  public enum Compression {
    ...
    Compression(String description, int value) {
      this.description = description;
      this.value = value;
    }
  ...
  public enum PlanarConfiguration {
    ...
    PlanarConfiguration(String description, int value) {
      this.description = description;
      this.value = value;
    }
  ...
  public enum ResolutionUnit {
    ...
    ResolutionUnit(String description, int value) {
      this.description = description;
      this.value = value;
    }
