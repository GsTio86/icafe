  ...
  public void read() throws IOException {
    ...
    switch (chunk.getChunkType()) {
      case ZTXT: {
        ...
        this.keyword = new String(data, 0, keyword_len, StandardCharsets.UTF_8);
      ...
      case TEXT: {
        ...
        this.keyword = new String(data, 0, keyword_len, StandardCharsets.UTF_8);
        sb.append(new String(data, keyword_len + 1, data.length - keyword_len - 1,
      ...
      case ITXT: {
        ...
        sb.append(new String(data, 0, keyword_len, StandardCharsets.UTF_8));
        ...
        if (lang_flg_len > 0) {
          sb.append(
              new String(data, keyword_len - lang_flg_len, lang_flg_len, StandardCharsets.UTF_8));
        }
        while (data[++keyword_len] != 0) {
          trans_keyword_len++;
        }
        if (trans_keyword_len > 0) {
          sb.append(" ");
          sb.append(new String(data, keyword_len - trans_keyword_len, trans_keyword_len,
              StandardCharsets.UTF_8));
        }
        sb.append(")");
