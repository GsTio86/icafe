...
public class Filter {
  ...
  public static void defilter_average(int bytesPerPixel, int bytesPerScanLine, byte[] sample,
      int offset) {
    int previous = 0;
    int upper = 0;
  ...
  public static void defilter_paeth(int bytesPerPixel, int bytesPerScanLine, byte[] sample,
      int offset) {
    int previous = 0;
    int upper = 0;
  ...
  public static void defilter_sub(int bytesPerPixel, int bytesPerScanLine, byte[] sample,
      int offset) {
    int end = offset + bytesPerScanLine;
  ...
  public static void filter_average(int bytesPerPixel, int bytesPerScanLine, byte[] sample,
      int offset) {
    int previous = 0;
    int upper = 0;
  ...
  public static void filter_paeth(int bytesPerPixel, int bytesPerScanLine, byte[] sample,
      int offset) {
    int previous = 0;
    int upper = 0;
    int upper_left = 0;
  ...
  public static void filter_sub(int bytesPerPixel, int bytesPerScanLine, byte[] sample,
      int offset) {
