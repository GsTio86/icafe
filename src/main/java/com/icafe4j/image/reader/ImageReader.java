 ...
 * WY    30May2015  Changed getFrames() to return an empty list instead of null WY    02Jan2015
 * Added getFrames() and getFrameCount() for multiple frame images WY    29May2015  Removed debug
 * field, replace with logging
 */
