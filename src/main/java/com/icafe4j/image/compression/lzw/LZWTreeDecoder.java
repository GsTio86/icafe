 ...
 * WY    14Oct2014  Revised to show specification violation TIFF LZW compression which actually
 * falls back to GIF LZW compression completely
 */
...
public class LZWTreeDecoder implements ImageDecoder {
  ...
  private static final int[]
      MASK =
      {0x00, 0x001, 0x003, 0x007, 0x00f, 0x01f, 0x03f, 0x07f, 0x0ff, 0x1ff, 0x3ff, 0x7ff, 0xfff};
  ...
  public void setInput(byte[] input, int offset, int len) {
    isCodeBigEndian = input[offset] != 0x00 || input[offset + 1] != 0x01;
