 ...
 * <p>
 * Expressions are parsed by the class <b>ParseExpression</b> which creates a parse tree using
 * objects of type expression. The subclasses
...
class Expression {
  ...
  /**
   * This method evaluates the expression in the context of the passed in program. It throws runtime
   * errors for things like no such variable and divide by zero.
   * <p>
   * Note that for boolean operations the value 1.0 == true and the value 0.0 is equivalent to
   * false.
   */
