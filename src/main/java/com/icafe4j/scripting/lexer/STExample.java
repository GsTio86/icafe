...
/**
 * A simple interactive calculator. FieldType in the entries of the form "<variable> = <expression>"
 * or simple "= <expression>" In the first case the value of the expression will be assigned to the
 * named variable, in the latter the value of the expression is simply printed.
 * <p>
 * Instead of an expression you can type the following commands: dump - dump out currently defined
 * variables clear - clears all defined variables. quit or exit - exits the application. help -
 * gives a brief help message.
 */
