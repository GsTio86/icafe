...
/**
 * This class implements a simple recursive-descent parser for the expression grammar I have
 * designed. As an exercise it is right out of Aho and Ullman's compiler design text.
 * <p>
 * This grammar is defined with some nonterminals that allow us to embed the precedence relationship
 * of operators into the grammar. The grammar is defined as follows:
 * <p>
 * ELEMENT    ::=   id |    constant |    "(" expression ")" PRIMARY    ::=   "-" ELEMENT |    "!"
 * ELEMENT |    ELEMENT FACTOR     ::=   PRIMARY "^" FACTOR |    PRIMARY TERM       ::=   TERM "*"
 * FACTOR |    TERM "/" FACTOR |    FACTOR SUM        ::=   SUM "+" TERM |    SUM "-" TERM |    TERM
 * EXPRESSION ::=   EXPRESSION "&" SUM |    EXPRESSION "#" SUM |    EXPRESSION "|" SUM |    SUM
 * <p>
 * Precidence rules from lowest to highest : 1.  &, |, ^ 2.  +, - 3.  *, / 4.  ** 5.  unary -, unary
 * !
 */
