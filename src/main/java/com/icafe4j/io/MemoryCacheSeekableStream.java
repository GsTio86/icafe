 ...
 * <code>InputStream</code>.  Seeking backwards is supported by means of an in-memory cache.  For
 * greater efficiency,
...
public final class MemoryCacheSeekableStream extends SeekableStream {
   ...
   * <code>InputStream</code>. Seeking backwards is supported by means of an in-memory cache.
   */
