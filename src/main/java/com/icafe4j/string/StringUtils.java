 ...
 * WY    03May2015  Added rationalToString() WY    04Mar2015  Added toHexString() WY    04Mar2015
 * Added generateMD5() WY    07Feb201   Added decimalToDMS() and DMSToDecimal() WY    23Jan2015
 * Moved XML related methods to XMLUtils WY    10Jan2015  Added showXML() and printNode() to show
 * XML document WY    28Dec2014  Added isInCharset() to test if a String can be encoded with certain
 * character set.
 */
...
public class StringUtils {
  ...
  public static String replaceLast(String input, String regex, String replacement) {
    return input.replaceAll(regex + "(?!.*" + regex + ")",
        replacement); // Using negative look ahead
  }
  ...
  private static void reverseIt(String str, String delimiter, StringBuilder sb) {
    ...
    sb.append(delimiter);
    sb.append(str, 0, str.indexOf(delimiter));
  }
  ...
  public static String toUTF16BE(byte[] data, int start, int length) {
    ...
    retVal = new String(data, start, length, StandardCharsets.UTF_16BE);
   ...
   */
  public double DMSToDecimal(String hemisphereOUmeridien, double degrees, double minutes,
      double seconds) {
    double LatOrLon = 0;
    double sign = 1.0;
