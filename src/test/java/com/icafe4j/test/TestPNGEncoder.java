...
/**
 * TestPNGEncoder creates a PNG file that shows an analog clock displaying the current time of day,
 * optionally with an alpha channel, and with the specified filter.
 * <p>
 ...
 * <p>
 * This test program was written in a burning hurry, so it is not a model of efficient, or even
 * good, code. Comments and bug fixes should be directed to:
 * <p>
 * david@catcode.com
 *
