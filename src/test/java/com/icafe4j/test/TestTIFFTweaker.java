  ...
  public void test(String... args) throws Exception {
    ...
    if (args.length > 1) {
      if (args[1].equalsIgnoreCase("copycat")) {
        ...
        rout.close();
        fout.close();
      } else if (args[1].equalsIgnoreCase("writemultipage") || args[1].equalsIgnoreCase(
          "insertpage")) {
        ...
        ImageParamBuilder builder = ImageParam.getBuilder();
        ...
        frames[0].setFrameParam(
            builder.colorType(ImageColorType.GRAY_SCALE).hasAlpha(true).build());
        ...
        ImageParam param = builder.colorType(ImageColorType.BILEVEL).applyDither(true).ditherMethod(
            DitherMethod.BAYER).imageOptions(tiffOptions).build();
        ...
        if (args[1].equalsIgnoreCase("writemultipage")) {
          ...
          BufferedImage im =
              new BufferedImage(width, height, BufferedImage.TYPE_BYTE_BINARY, colorModel);
