...
public class TestImageReader extends TestBase {
  ...
  public void test(String... args) throws Exception {
    ...
    ImageIO.write(img, fo, imageType, builder.quantMethod(QuantMethod.WU_QUANT).colorType(
            ImageColorType.INDEXED).applyDither(true).ditherMethod(DitherMethod.FLOYD_STEINBERG)
        .hasAlpha(true).build());
